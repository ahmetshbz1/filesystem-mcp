...
function detectCompressionFormat(filePath: string): 'gzip' | 'brotli' | null {
...
export const handlers = {
  compress_file: async (args: z.infer<typeof CompressFileArgsSchema>) => {
  ...
  decompress_file: async (args: z.infer<typeof DecompressFileArgsSchema>) => {
