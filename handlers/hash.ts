...
async function calculateHash(filePath: string, algorithm: string): Promise<string> {
...
export const tools = [
  {
    ...
    inputSchema: zodToJsonSchema(FileHashArgsSchema) as ToolInput
  },
  {
    name: 'batch_hash',
    description: 'Calculate hashes for multiple files',
    inputSchema: zodToJsonSchema(BatchHashArgsSchema) as ToolInput
  },
  {
    name: 'verify_hash',
    description: 'Verify file integrity by comparing hash',
    inputSchema: zodToJsonSchema(VerifyHashArgsSchema) as ToolInput
  },
  {
    name: 'directory_hash',
    description: 'Calculate hashes for all files in directory recursively',
    inputSchema: zodToJsonSchema(DirectoryHashArgsSchema) as ToolInput
  }
];

export const handlers = {
  file_hash: async (args: z.infer<typeof FileHashArgsSchema>) => {
  ...
  batch_hash: async (args: z.infer<typeof BatchHashArgsSchema>) => {
  ...
  verify_hash: async (args: z.infer<typeof VerifyHashArgsSchema>) => {
  ...
  directory_hash: async (args: z.infer<typeof DirectoryHashArgsSchema>) => {
