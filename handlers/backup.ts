...
async function findBackups(filePath: string): Promise<{ path: string; created: Date; size: number }[]> {
...
export const tools = [
  {
    ...
    inputSchema: zodToJsonSchema(FileBackupArgsSchema) as ToolInput
  },
  {
    name: 'restore_backup',
    description: 'Restore file from backup',
    inputSchema: zodToJsonSchema(RestoreBackupArgsSchema) as ToolInput
  },
  {
    name: 'list_backups',
    description: 'List all backups for a file',
    inputSchema: zodToJsonSchema(ListBackupsArgsSchema) as ToolInput
  },
  {
    name: 'rotate_backups',
    description: 'Rotate backups, keeping only the N most recent',
    inputSchema: zodToJsonSchema(RotateBackupsArgsSchema) as ToolInput
  }
];

export const handlers = {
  file_backup: async (args: z.infer<typeof FileBackupArgsSchema>) => {
  ...
  restore_backup: async (args: z.infer<typeof RestoreBackupArgsSchema>) => {
  ...
  list_backups: async (args: z.infer<typeof ListBackupsArgsSchema>) => {
  ...
  rotate_backups: async (args: z.infer<typeof RotateBackupsArgsSchema>) => {
