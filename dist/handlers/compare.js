...
export const tools = [{
        ...
        inputSchema: zodToJsonSchema(CompareArgsSchema)
    }];
...
async function handleTextCompare(path1, path2, data) {
...
async function handleBinaryCompare(path1, path2) {
...
async function handleDirectoryCompare(dir1, dir2, data) {
...
async function compareDirectories(dir1, dir2, recursive, compareContent) {
    const result = { onlyInFirst: [], onlyInSecond: [], different: [], identical: [] };
